...
const TeacherComments = () => {
  ...
  const handleArmSelect = async (arm) => {
    ...
    try {
      ...
      reports.forEach((r) => {
        ...
        if (sid) existingComments[sid] = r.classTeacherComment || "";
      });
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await api.post("/term-reports/class-teacher", { reports: payload });

      alert("✅ Teacher comments saved successfully!");
    } catch (err) {
